...
subprocess.run(['git', 'fetch', '-q', '--tags', 'origin', 'yolo'])
subprocess.run(['git', 'reset', '-q', '--hard', f'origin/yolo'])
subprocess.run(['git', 'add', '.'])
subprocess.run(['git', 'commit', '-q', '-m', '🚀 boom burst the big bang'])
subprocess.run(['git', 'tag', '-f', 'yolo'])
subprocess.run(['git', 'push', '-q', '--tags', 'origin', 'yolo'])